...
//    "2018/5/20 8:28:00";
     ...
     *
     */
    public void setData(final ArrayList<VocBean> beans )
    {
        ...
        {
//            bigList.get(0).add(new Entry(i,Float.parseFloat(beans.get(i).voc1)));
//            bigList.get(1).add(new Entry(i,Float.parseFloat(beans.get(i).voc1)));
            entries.add(new Entry(i,Float.parseFloat(beans.get(i).voc1)));
            entries1.add(new Entry(i,Float.parseFloat(beans.get(i).voc2)));
        }

//        设置刻度，个刻度，两个小时一个刻度
        xAxis.setLabelCount(count, true);

        LineDataSet lineDataSet1 = new LineDataSet(entries, "VOC1");
        LineDataSet lineDataSet2= new LineDataSet(entries1, "VOC2");
