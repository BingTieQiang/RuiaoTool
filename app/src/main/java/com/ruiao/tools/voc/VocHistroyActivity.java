...
public class VocHistroyActivity extends Activity {
    ...
    private class DataAdapter extends RecyclerView.Adapter {
        ...
        public DataAdapter(Context context, ArrayList<VocBean> mDataList) {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            ...
            viewHolder.title.setText("VOC1:" + mDataList.get(position).voc1 + "");
            viewHolder.context.setText(mDataList.get(position).date);
            viewHolder.time.setText("VOC2:" + mDataList.get(position).voc2);
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    if (status) {
                        ...
                        if(type.equals("fen")){
                            voclist1 = response.getJSONArray("VOC1");
                            voclist2 = response.getJSONArray("VOC2");
                        }else {
                            voclist1 = response.getJSONArray("VOC1平均值");
                            voclist2 = response.getJSONArray("VOC2平均值");
                        }
