...
public class BarChartManager {
    ...
    private XAxis xAxis;
    private SimpleDateFormat format = new SimpleDateFormat("MM-dd/HH");
...
//        legend.setEnabled(false);
    ...
    public void showBarChart(List<Float> xAxisValues, List<Float> yAxisValues, String label, int color) {
        for(int i = 0;i<xAxisValues.size();i++){
            ...
            datalist.add(new Date(nowtime));
            nowtime += 1 * 60 * 60 * 1000;
        ...
        xAxis.setValueFormatter(new IAxisValueFormatter() {
            ...
            public String getFormattedValue(float value, AxisBase axis) {
                ...
                return format.format(datalist.get((int)value));
//                if(pos%6==0){
//                    return format.format(datalist.get((int)value));
//                }else {
//                    return "";
