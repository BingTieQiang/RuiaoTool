...
//分钟数据
public class AqiZhouActivity extends AppCompatActivity {
    Date data = new Date();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.aqi_zhou);
        ...
        tvNewDate.setText(format2.format(new Date(time_num)) + "->" + format3.format(  new Date(time_num + 1000 * 3600 * 24 * 7) ));
    }
