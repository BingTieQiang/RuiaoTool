...
public class BarChartManager {
    ...
    SimpleDateFormat format_n = new SimpleDateFormat("yyyy MM月dd日hh:mm");  //2019-05-02 08:08:08
    //构造
    ...
    public void initLineChart(String laber) {
        ...
        xAxis.setValueFormatter(new IAxisValueFormatter() {
            ...
            public String getFormattedValue(float value, AxisBase axis) {
                String newTime = times.get((int)value);

                try {
                    return format.format(format_n.parse(newTime))+"时";
