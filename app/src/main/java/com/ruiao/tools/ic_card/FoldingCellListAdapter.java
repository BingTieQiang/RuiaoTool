...
public class FoldingCellListAdapter extends ArrayAdapter<Item> {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (cell == null) {
            ...
            cell = (FoldingCell) vi.inflate(R.layout.item_ic_device_state, parent, false);
            // binding view parts to view holder
            viewHolder.dayData = (TextView) cell.findViewById(R.id.content_request_btn);
...
//        }
        ...
        if(defaultRequestBtnClickListener!=null)
        {
            viewHolder.dayData.setOnClickListener(defaultRequestBtnClickListener);
        }
